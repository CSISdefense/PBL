...
PBLscore  <- read.csv(
    paste("Data\\Contract_SP_ContractPBLscoreSubCustomerProdServOffice.csv", sep = ""),
...
DLApblScore<-subset(PBLscore,SubCustomer=="DLA")
...
PBLgraph<-LatticePlotWrapper(
    ...
    ,"Contract Obligations, 2014 Billions"
    ,Coloration
    ,subset(PBLscore,SubCustomer.detail=="DLA")
    ,NA
    ,"Fiscal.Year"
    ,"Obligation.2014"
    ,"AddressCat"
